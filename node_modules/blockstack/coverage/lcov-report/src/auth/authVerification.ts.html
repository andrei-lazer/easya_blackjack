...
<html lang="en">
<head>
    <title>Code coverage report for src/auth/authVerification.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/auth</a> authVerification.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">76.85% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>83/108</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { decodeToken, TokenVerifier } from 'jsontokens'
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Unexpected token payload type of string')</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (publicKeys.length === 1) {
    const publicKey = publicKeys[0]
    try {
      const tokenVerifier = new TokenVerifier('ES256k', publicKey)
      const signatureVerified = tokenVerifier.verify(token)
      <span class="missing-if-branch" title="else path not taken" >E</span>if (signatureVerified) {
        return true
      } else {
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Multiple public keys are not supported')</span>
  }
}
&nbsp;
/**
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (publicKeys.length === 1) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (addressFromPublicKeys === addressFromIssuer) {
      return true
    }
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error('Multiple public keys are not supported')</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (payload.username === null) {
<span class="cstat-no" title="statement not covered" >      return true</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nameLookupURL === null) {
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (responseJSON.hasOwnProperty('address')) {
      const nameOwningAddress = responseJSON.address
      const addressFromIssuer = getAddressFromDID(payload.iss)
      <span class="missing-if-branch" title="else path not taken" >E</span>if (nameOwningAddress === addressFromIssuer) {
        return true
      } else {
<span class="cstat-no" title="statement not covered" >        return false</span>
      }
...
<span class="cstat-no" title="statement not covered" >    console.log('Error checking `doPublicKeysMatchUsername`')</span>
<span class="cstat-no" title="statement not covered" >    return false</span>
  }
}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Unexpected token payload type of string')</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (payload.iat) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof payload.iat !== 'number') {
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
    const issuedAt = new Date(payload.iat * 1000) // JWT times are in seconds
    <span class="missing-if-branch" title="if path not taken" >I</span>if (new Date().getTime() &lt; issuedAt.getTime()) {
<span class="cstat-no" title="statement not covered" >      return false</span>
    } else {
      return true
    }
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Unexpected token payload type of string')</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (payload.exp) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof payload.exp !== 'number') {
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
    const expiresAt = new Date(payload.exp * 1000) // JWT times are in seconds
    <span class="missing-if-branch" title="if path not taken" >I</span>if (new Date().getTime() &gt; expiresAt.getTime()) {
<span class="cstat-no" title="statement not covered" >      return false</span>
    } else {
      return true
    }
...
export async function verifyAuthRequest(token: string): Promise&lt;boolean&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (decodeToken(token).header.alg === 'none') {
<span class="cstat-no" title="statement not covered" >    throw new Error('Token must be signed in order to be verified')</span>
  }
