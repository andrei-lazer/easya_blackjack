...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/sha2Hash.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> sha2Hash.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">42x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { sha256, sha512 } from 'sha.js'
...
&nbsp;
  async digest(data: Buffer, algorithm = <span class="branch-0 cbranch-no" title="branch not covered" >'sha256')</span>: Promise&lt;Buffer&gt; {
    let algo: string
    if (algorithm === 'sha256') {
      algo = 'SHA-256'
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (algorithm === 'sha512') {
      algo = 'SHA-512'
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unsupported hash algorithm ${algorithm}`)</span>
    }
    try {
