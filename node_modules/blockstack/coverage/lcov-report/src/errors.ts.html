...
<html lang="en">
<head>
    <title>Code coverage report for src/errors.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> errors.ts
    </h1>
    <div class='clearfix'>
...
<a name='L320'></a><a href='#L320'>320</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  constructor(error: ErrorData) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!stack) { 
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error()</span>
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        stack = e.stack</span>
      }
    } else {
  ...
  toString() {
    ...
    code: ${this.code} param: ${this.parameter ? <span class="branch-0 cbranch-no" title="branch not covered" >this.parameter </span>: 'n/a'}`
  }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >  constructor(p</span>arameter: string, message: string = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
<span class="cstat-no" title="statement not covered" >    super({ code: ERROR_CODES.MISSING_PARAMETER, message, parameter: '' })</span>
<span class="cstat-no" title="statement not covered" >    this.name = 'MissingParametersError'</span>
  }
}
&nbsp;
/**
...
export class InvalidDIDError extends BlockstackError {
  constructor(message: string = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
export class FailedDecryptionError extends BlockstackError {
  constructor(message: string = <span class="branch-0 cbranch-no" title="branch not covered" >'Unable to decrypt cipher object.')</span> {
...
<span class="cstat-no" title="statement not covered" >    super({ code: ERROR_CODES.INVALID_STATE, message })</span>
<span class="cstat-no" title="statement not covered" >    this.message = message</span>
<span class="cstat-no" title="statement not covered" >    this.name = 'InvalidStateError'</span>
  }
}
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    super({ code: ERROR_CODES.INVALID_STATE, message })</span>
<span class="cstat-no" title="statement not covered" >    this.message = message</span>
<span class="cstat-no" title="statement not covered" >    this.name = 'NoSessionDataError'</span>
  }
}
&nbsp;
/**
...
&nbsp;
  constructor(error: ErrorData, response: GaiaHubErrorResponse) {
    ...
    if (response) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof response.body === 'string') {
        this.hubError.message = response.body
      } else <span class="cstat-no" title="statement not covered" >if (typeof response.body === 'object') {</span>
<span class="cstat-no" title="statement not covered" >        Object.assign(this.hubError, response.body)</span>
      }
    }
  }
}
...
<span class="fstat-no" title="function not covered" >  constructor(m</span>essage: string, response: GaiaHubErrorResponse) {
<span class="cstat-no" title="statement not covered" >    super({ message, code: ERROR_CODES.CONFLICT_ERROR }, response)</span>
...
<span class="fstat-no" title="function not covered" >  constructor(m</span>essage: string, response: GaiaHubErrorResponse) {
<span class="cstat-no" title="statement not covered" >    super({ message, code: ERROR_CODES.NOT_ENOUGH_PROOF_ERROR }, response)</span>
<span class="cstat-no" title="statement not covered" >    this.name = 'NotEnoughProofError'</span>
  }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >  constructor(m</span>essage: string, response: GaiaHubErrorResponse) {
<span class="cstat-no" title="statement not covered" >    super({ message, code: ERROR_CODES.BAD_PATH_ERROR }, response)</span>
<span class="cstat-no" title="statement not covered" >    this.name = 'BadPathError'</span>
  }
}
&nbsp;
/**
