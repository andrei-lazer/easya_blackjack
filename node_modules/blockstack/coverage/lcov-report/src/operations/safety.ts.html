...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/safety.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> safety.ts
    </h1>
    <div class='clearfix'>
...
* @ignore
*/
function isNameValid(fullyQualifiedName: string = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
function isNameAvailable(fullyQualifiedName: string) {
  return config.network.getNameInfo(fullyQualifiedName)
    .then(() =&gt; false)
    .catch((e) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (e.message === 'Name not found') {
        return true
      } else {
...
<span class="cstat-no" title="statement not covered" >      if (e.message === 'Name not found') {</span>
...
function revealedNamespace(namespaceID: string, revealAddress: string) {
  return config.network.getNamespaceInfo(namespaceID)
    ...
    .catch((e) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (e.message === 'Namespace not found') {
        return false
      } else {
<span class="cstat-no" title="statement not covered" >        throw e</span>
      }
...
* @ignore
*/
function <span class="fstat-no" title="function not covered" >isAccountSpendable(</span>address: string, tokenType: string, blockHeight: number) {
<span class="cstat-no" title="statement not covered" >  return config.network.getAccountStatus(address, tokenType)</span>
    .then(<span class="fstat-no" title="function not covered" >accountStatus </span>=&gt; <span class="cstat-no" title="statement not covered" >accountStatus.transfer_send_block_id &gt;= blockHeight)</span>
}
&nbsp;
/**
* @ignore
