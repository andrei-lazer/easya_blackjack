...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> utils.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.89% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>93/95</span>
      </div>
      <div class='fl pad1y space-right2'>
...
function inputBytes(input: txPoint | null) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (input &amp;&amp; input.script &amp;&amp; input.script.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >    return TX_INPUT_BASE + input.script.length</span>
  } else {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (newFees &gt;= largest.value) {
<span class="cstat-no" title="statement not covered" >      throw new NotEnoughFundsError(amountToFund)</span>
    }
&nbsp;
