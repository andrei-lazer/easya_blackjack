...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/profileLookup.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/profiles</a> profileLookup.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    return Promise.reject()</span>
  ...
  return lookupPromise
    .then((responseJSON) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (responseJSON.hasOwnProperty('zonefile')
          &amp;&amp; responseJSON.hasOwnProperty('address')) {
        return resolveZoneFileToProfile(responseJSON.zonefile, responseJSON.address)
      } else {
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid zonefile lookup response: did not contain `address`'</span>
                        + ' or `zonefile` field')
      }
    })
}
