...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/services/github.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/profiles/services</a> github.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    for (let i = 0; i &lt; baseUrls.length; i++) {
      ...
      if (proofUrl.startsWith(requiredPrefix)) {
        const raw = proofUrl.endsWith('/') ? <span class="branch-0 cbranch-no" title="branch not covered" >'raw' </span>: '/raw'
        return `${proofUrl}${raw}`
      }
    }
