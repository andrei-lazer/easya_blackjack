...
<html lang="en">
<head>
    <title>Code coverage report for src/public.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> public.ts
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >  console.error(`Error performing global protocol echo reply detection: ${error}`)</span>
}
&nbsp;
export * from './auth'
