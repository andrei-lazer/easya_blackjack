...
<html lang="en">
<head>
    <title>Code coverage report for src/storage/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/storage</a> index.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">80.85% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>304/376</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.3% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>186/247</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">80.59% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>299/371</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1014'></a><a href='#L1014'>1014</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export async function getUserAppFileUrl(
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (profile.hasOwnProperty('apps')) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (profile.apps.hasOwnProperty(appOrigin)) {
...
export async function encryptContent(
  ...
  if (opts.sign) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opts.sign === 'string') {
<span class="cstat-no" title="statement not covered" >      privateKey = opts.sign</span>
    } else if (!privateKey) {
      privateKey = caller.loadUserData().appPrivateKey
    }
...
<span class="cstat-no" title="statement not covered" >    if (err instanceof SyntaxError) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Failed to parse encrypted content JSON. The content may not '</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Failed to parse gaia address')</span>
  }
...
function normalizeOptions&lt;T&gt;(
  ...
  if (opts.username) {
    if (!opts.app) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!caller.appConfig) {
<span class="cstat-no" title="statement not covered" >        throw new InvalidStateError('Missing AppConfig')</span>
      }
...
<span class="cstat-no" title="statement not covered" >        throw new InvalidStateError('Missing AppConfig')</span>
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!caller.store) {
<span class="cstat-no" title="statement not covered" >        throw new InvalidStateError('Missing store UserSession')</span>
      }
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!readUrl) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Missing readURL')</span>
  } else {
    return readUrl
  }
}
...
async function getFileContents(caller: UserSession, path: string, app: string,
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof contentType === 'string') {
    contentType = contentType.toLowerCase()
  }
&nbsp;
  const etag = response.headers.get('ETag')
  <span class="missing-if-branch" title="if path not taken" >I</span>if (etag) {
    const sessionData = <span class="cstat-no" title="statement not covered" >caller.store.getSessionData()</span>
<span class="cstat-no" title="statement not covered" >    sessionData.etags[path] = etag</span>
<span class="cstat-no" title="statement not covered" >    caller.store.setSessionData(sessionData)</span>
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (forceText || contentType === null
    || contentType.startsWith('text')
    || contentType.startsWith('application/json')) {
    return response.text()
  } else {
<span class="cstat-no" title="statement not covered" >    return response.arrayBuffer()</span>
  }
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!fileContents) {
<span class="cstat-no" title="statement not covered" >      return fileContents</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!gaiaAddress) {
<span class="cstat-no" title="statement not covered" >      throw new SignatureVerificationError('Failed to get gaia address for verification of: '</span>
                                            + `${path}`)
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!signatureContents || typeof signatureContents !== 'string') {
<span class="cstat-no" title="statement not covered" >      throw new SignatureVerificationError('Failed to obtain signature for file: '</span>
...
<span class="cstat-no" title="statement not covered" >      if (err instanceof SyntaxError) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Failed to parse signature content JSON '</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!address) {
<span class="cstat-no" title="statement not covered" >    throw new SignatureVerificationError('Failed to get gaia address for verification of: '</span>
                                          + `${path}`)
  }
  let sigObject
...
<span class="cstat-no" title="statement not covered" >    if (err instanceof SyntaxError) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Failed to parse encrypted, signed content JSON. The content may not '</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!signerPublicKey || !cipherText || !signature) {
<span class="cstat-no" title="statement not covered" >    throw new SignatureVerificationError(</span>
    ...
    throw new SignatureVerificationError('Contents do not match ECDSA signature in file:'
                                          + ` ${path}`)
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof (privateKey) === 'string') {
    const decryptOpt = <span class="cstat-no" title="statement not covered" >{ privateKey }</span>
<span class="cstat-no" title="statement not covered" >    return caller.decryptContent(cipherText, decryptOpt)</span>
  } else {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (storedContents === null) {
<span class="cstat-no" title="statement not covered" >    return storedContents</span>
  } else if (opt.decrypt &amp;&amp; !opt.verify) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof storedContents !== 'string') {
<span class="cstat-no" title="statement not covered" >      throw new Error('Expected to get back a string for the cipherText')</span>
    }
...
<span class="cstat-no" title="statement not covered" >      throw new Error('Expected to get back a string for the cipherText')</span>
    ...
    let decryptionKey
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof (opt.decrypt) === 'string') {
<span class="cstat-no" title="statement not covered" >      decryptionKey = opt.decrypt</span>
    }
    return handleSignedEncryptedContents(caller, path, storedContents,
                                         opt.app, decryptionKey, opt.username,
                                         opt.zoneFileLookupURL)
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (!opt.verify &amp;&amp; !opt.decrypt) {
    return storedContents
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error('Should be unreachable.')</span>
  }
}
&nbsp;
/** @ignore */
  ...
  private static normalizeContentDataType(content: PutFileContent,
    ...
    try {
      if (typeof content === 'string') {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (charset.includes('charset') &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!charset.includes('charset=utf8') </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >!charset.includes('charset=ascii'))</span> {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to determine byte length with charset: ${contentType}`)</span>
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof TextEncoder !== 'undefined') {
          const encodedString = new TextEncoder().encode(content)
          return Buffer.from(encodedString.buffer)
        }
<span class="cstat-no" title="statement not covered" >        return Buffer.from(content)</span>
      } else if (Buffer.isBuffer(content)) {
        return content
      } else if (ArrayBuffer.isView(content)) {
        return Buffer.from(content.buffer, content.byteOffset, content.byteLength)
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Blob !== 'undefined' &amp;&amp; content instanceof Blob) {
        return content
      } else <span class="cstat-no" title="statement not covered" >if (typeof ArrayBuffer !== 'undefined' &amp;&amp; content instanceof ArrayBuffer) {</span>
<span class="cstat-no" title="statement not covered" >        return Buffer.from(content)</span>
      } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(content)) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (content.length &gt; 0</span>
          &amp;&amp; (!Number.isInteger(content[0]) || content[0] &lt; 0 || content[0] &gt; 255)) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unexpected array values provided as file data: value "${content[0]}" at index 0 is not an octet number. ${this.supportedTypesMsg}`)</span>
        }
<span class="cstat-no" title="statement not covered" >        return Buffer.from(content)</span>
      } else {
        const typeName = <span class="cstat-no" title="statement not covered" >Object.prototype.toString.call(content)</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Unexpected type provided as file data: ${typeName}. ${this.supportedTypesMsg}`)</span>
      }
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      console.error(error)</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`Error processing data: ${error}`)</span>
    }
  }
&nbsp;
...
&nbsp;
  private detectContentLength(): number {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Blob !== 'undefined' &amp;&amp; this.content instanceof Blob) {
      return this.content.size
    }
    const typeName = <span class="cstat-no" title="statement not covered" >Object.prototype.toString.call(this.content)</span>
    const error = <span class="cstat-no" title="statement not covered" >new Error(`Unexpected type "${typeName}" while detecting content length`)</span>
<span class="cstat-no" title="statement not covered" >    console.error(error)</span>
  ...
  private async loadContent(): Promise&lt;Buffer&gt; {
    try {
      if (Buffer.isBuffer(this.content)) {
        return this.content
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (ArrayBuffer.isView(this.content)) {
<span class="cstat-no" title="statement not covered" >        return Buffer.from(this.content.buffer, this.content.byteOffset, this.content.byteLength)</span>
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Blob !== 'undefined' &amp;&amp; this.content instanceof Blob) {
        const reader = new FileReader()
        const readPromise = new Promise&lt;Buffer&gt;((resolve, reject) =&gt; {
          reader.onerror = <span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
<span class="cstat-no" title="statement not covered" >            reject(err)</span>
        ...
        const typeName = <span class="cstat-no" title="statement not covered" >Object.prototype.toString.call(this.content)</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Unexpected type ${typeName}`)</span>
      }
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      console.error(error)</span>
      const loadContentError = <span class="cstat-no" title="statement not covered" >new Error(`Error loading content: ${error}`)</span>
<span class="cstat-no" title="statement not covered" >      console.error(loadContentError)</span>
<span class="cstat-no" title="statement not covered" >      throw loadContentError</span>
    }
  }
&nbsp;
  load(): Promise&lt;Buffer | string&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.loadedData === undefined) {
...
function isRecoverableGaiaError(error: GaiaHubError): boolean {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!error || !error.hubError || !error.hubError.statusCode) {
<span class="cstat-no" title="statement not covered" >    return false</span>
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (statusCode === 409) {
<span class="cstat-no" title="statement not covered" >    return true</span>
  }
  // 500s: possible server-side transient error
  <span class="missing-if-branch" title="if path not taken" >I</span>if (statusCode &gt;= 500 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >statusCode &lt;= 599)</span> {
<span class="cstat-no" title="statement not covered" >    return true</span>
  }
  return false
}
...
&nbsp;
  ...
  const sessionData = caller.store.getSessionData();
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!opt.dangerouslyIgnoreEtag) {
...
&nbsp;
  ...
  if (!opt.encrypt &amp;&amp; opt.sign) {
    ...
    let privateKey: string
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opt.sign === 'string') {
<span class="cstat-no" title="statement not covered" >      privateKey = opt.sign</span>
    } else {
      privateKey = caller.loadUserData().appPrivateKey
    }
...
&nbsp;
    uploadFn = async (hubConfig: GaiaHubConfig) =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (writeResponse.etag) {
<span class="cstat-no" title="statement not covered" >        sessionData.etags[path] = writeResponse.etag;</span>
<span class="cstat-no" title="statement not covered" >        caller.store.setSessionData(sessionData);</span>
      }
    ...
    if (!opt.encrypt &amp;&amp; !opt.sign) {
      ...
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof opt.sign === 'string') {
<span class="cstat-no" title="statement not covered" >        publicKey = getPublicKeyFromPrivate(opt.sign)</span>
      } else {
...
export async function deleteFile(
  ...
  if (opts.wasSigned) {
    ...
    try {
      ...
      const freshHubConfig = <span class="cstat-no" title="statement not covered" >await caller.setLocalGaiaHubConnection()</span>
<span class="cstat-no" title="statement not covered" >      await deleteFromGaiaHub(path, freshHubConfig)</span>
<span class="cstat-no" title="statement not covered" >      await deleteFromGaiaHub(`${path}${SIGNATURE_FILE_SUFFIX}`, gaiaHubConfig)</span>
<span class="cstat-no" title="statement not covered" >      delete sessionData.etags[path];</span>
<span class="cstat-no" title="statement not covered" >      caller.store.setSessionData(sessionData);</span>
    }
  } else {
    try {
 ...
 */
export function <span class="fstat-no" title="function not covered" >getAppBucketUrl(</span>gaiaHubUrl: string, appPrivateKey: string) {
<span class="cstat-no" title="statement not covered" >  return getBucketUrl(gaiaHubUrl, appPrivateKey)</span>
}
&nbsp;
/**
...
async function listFilesLoop(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (callCount &gt; 65536) {
    // this is ridiculously huge, and probably indicates
    // a faulty Gaia hub anyway (e.g. on that serves endless data)
<span class="cstat-no" title="statement not covered" >    throw new Error('Too many entries to list')</span>
  }
&nbsp;
  ...
  try {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (callCount === 0) {
      const freshHubConfig = await caller.setLocalGaiaHubConnection()
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (entries === null || entries === undefined) {
    // indicates a misbehaving Gaia hub or a misbehaving driver
    // (i.e. the data is malformed)
<span class="cstat-no" title="statement not covered" >    throw new Error('Bad listFiles response: no entries')</span>
  }
  let entriesLength = 0
  for (let i = 0; i &lt; entries.length; i++) {
    ...
    if (entries[i] !== null) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!rc) {
        // callback indicates that we're done
<span class="cstat-no" title="statement not covered" >        return fileCount + i</span>
      }
    }
  }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Aug 24 2020 16:23:18 GMT-0400 (Eastern Daylight Time)
</div>
</div>
