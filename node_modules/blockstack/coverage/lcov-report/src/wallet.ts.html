...
<html lang="en">
<head>
    <title>Code coverage report for src/wallet.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> wallet.ts
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>73/91</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L373'></a><a href='#L373'>373</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { payments, bip32, BIP32Interface, ECPair } from 'bitcoinjs-lib'
...
function hashCode(string: string) {
  let hash = 0
  <span class="missing-if-branch" title="if path not taken" >I</span>if (string.length === 0) <span class="cstat-no" title="statement not covered" >return hash</span>
...
export function getLegacyAppNode(appsNode: string | BIP32Interface, 
  ...
  const appNodeInstance = typeof appsNode === 'string' ? bip32.fromBase58(appsNode) : <span class="branch-1 cbranch-no" title="branch not covered" >appsNode</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  toBase58(</span>): string {
<span class="cstat-no" title="statement not covered" >    return this.rootNode.toBase58()</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   * @ignore
   */
<span class="fstat-no" title="function not covered" >  static </span>async fromEncryptedMnemonic(data: string | Buffer, password: string, 
                                     triplesecDecrypt: TriplesecDecryptSignature
  ): Promise&lt;BlockstackWallet&gt; {
<span class="cstat-no" title="statement not covered" >    try {</span>
      const mnemonic = <span class="cstat-no" title="statement not covered" >await decryptMnemonic(data, password, triplesecDecrypt)</span>
      const seed = <span class="cstat-no" title="statement not covered" >await mnemonicToSeed(mnemonic)</span>
<span class="cstat-no" title="statement not covered" >      return new BlockstackWallet(bip32.fromSeed(seed))</span>
    } catch (err) {
<span class="cstat-no" title="statement not covered" >      if (err.message &amp;&amp; err.message.startsWith('bad header;')) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Incorrect password')</span>
      } else {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  static </span>generateMnemonic() {
<span class="cstat-no" title="statement not covered" >    return generateMnemonic(128, randomBytes)</span>
  }
&nbsp;
  /**
   ...
   * 
   */
<span class="fstat-no" title="function not covered" >  static </span>async encryptMnemonic(mnemonic: string, password: string, opts?: {
    getRandomBytes?: GetRandomBytes
  }): Promise&lt;string&gt; {
    const encryptedBuffer = <span class="cstat-no" title="statement not covered" >await encryptMnemonic(mnemonic, password, opts)</span>
<span class="cstat-no" title="statement not covered" >    return encryptedBuffer.toString('hex')</span>
  }
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  getBitcoinPrivateKey(</span>addressIndex: number): string {
<span class="cstat-no" title="statement not covered" >    return getNodePrivateKey(this.getBitcoinNode(addressIndex))</span>
  }
&nbsp;
  /**
...
&nbsp;
  static getNodeFromBitcoinKeychain(
    ...
    addressIndex: number,
    chainType: string = <span class="branch-0 cbranch-no" title="branch not covered" >EXTERNAL_ADDRESS</span>
  ): BIP32Interface {
    let chain
    <span class="missing-if-branch" title="else path not taken" >E</span>if (chainType === EXTERNAL_ADDRESS) {
      chain = 0
    } else <span class="cstat-no" title="statement not covered" >if (chainType === CHANGE_ADDRESS) {</span>
<span class="cstat-no" title="statement not covered" >      chain = 1</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid chain type')</span>
    }
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  static </span>getAddressFromBitcoinKeychain(keychainBase58: string, addressIndex: number,
                                       chainType: string = <span class="branch-0 cbranch-no" title="branch not covered" >EXTERNAL_ADDRESS)</span>: string {
<span class="cstat-no" title="statement not covered" >    return BlockstackWallet.getAddressFromBIP32Node(BlockstackWallet</span>
...
&nbsp;
  ...
  static getAppPrivateKey(appsNodeKey: string, salt: string, appDomain: string): 
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hash.length !== 64) {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unexpected app-domain hash length of ${hash.length}`)</span>
    }
    ...
    appIndexHexes.forEach((hex) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (hex.length &gt; 6) {
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid hex string length')</span>
      }
...
&nbsp;
  ...
  getIdentityKeyPair(addressIndex: number, 
                     alwaysUncompressed: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span>: IdentityKeyPair {
