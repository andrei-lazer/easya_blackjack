...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/aesCipher.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> aesCipher.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  async encrypt(
    ...
    data: Buffer): 
    Promise&lt;Buffer&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (algorithm !== 'aes-128-cbc' &amp;&amp; algorithm !== 'aes-256-cbc') {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unsupported cipher algorithm "${algorithm}"`)</span>
    }
...
&nbsp;
  async encrypt(
    ...
    if (algorithm === 'aes-128-cbc') {
      algo = 'AES-CBC'
      length = 128
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (algorithm === 'aes-256-cbc') {
      algo = 'AES-CBC'
      length = 256
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unsupported cipher algorithm "${algorithm}"`)</span>
