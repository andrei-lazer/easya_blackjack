...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/cryptoUtils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> cryptoUtils.ts
    </h1>
    <div class='clearfix'>
...
export function isNodeCryptoAvailable&lt;T&gt;(
  ...
  try {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!resolvedResult) {
<span class="cstat-no" title="statement not covered" >      return false</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!cryptoModule) {
<span class="cstat-no" title="statement not covered" >      return false</span>
    }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (withFeature) {
...
<span class="cstat-no" title="statement not covered" >      throw new Error(NO_CRYPTO_LIB)</span>
    }
  }
}
&nbsp;</pre></td></tr>
