...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/hashRipemd160.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> hashRipemd160.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">158x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Ripemd160Polyfill from 'ripemd160-min'
...
export class Ripemd160PolyfillDigest implements Ripemd160Digest {
  digest(data: Buffer): Buffer {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(hash)) {
<span class="cstat-no" title="statement not covered" >      return Buffer.from(hash)</span>
    } else {
...
export function createHashRipemd160() {
  const nodeCryptoCreateHash = isNodeCryptoAvailable(nodeCrypto =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof nodeCrypto.createHash === 'function') {
      return nodeCrypto.createHash
    }
<span class="cstat-no" title="statement not covered" >    return false</span>
  })
  <span class="missing-if-branch" title="else path not taken" >E</span>if (nodeCryptoCreateHash) {
    return new NodeCryptoRipemd160Digest(nodeCryptoCreateHash)
  } else {
<span class="cstat-no" title="statement not covered" >    return new Ripemd160PolyfillDigest()</span>
  }
}
&nbsp;
