...
<html lang="en">
<head>
    <title>Code coverage report for src/encryption/wallet.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/encryption</a> wallet.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">89.86% </span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { validateMnemonic, mnemonicToEntropy, entropyToMnemonic } from 'bip39';
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hmacSigHash.equals(hmacDigestHash)) {
    // not authentic
<span class="cstat-no" title="statement not covered" >    throw new PasswordError('Wrong password (HMAC mismatch)');</span>
  }
&nbsp;
  let mnemonic: string;
  try {
...
<span class="cstat-no" title="statement not covered" >    console.error('Error thrown by `entropyToMnemonic`');</span>
<span class="cstat-no" title="statement not covered" >    console.error(error);</span>
<span class="cstat-no" title="statement not covered" >    throw new PasswordError('Wrong password (invalid plaintext)');</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!validateMnemonic(mnemonic)) {
<span class="cstat-no" title="statement not covered" >    throw new PasswordError('Wrong password (invalid plaintext)');</span>
  }
&nbsp;
  return mnemonic;
...
function decryptLegacy(
  ...
  return new Promise&lt;Buffer&gt;((resolve, reject) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!triplesecDecrypt) {
<span class="cstat-no" title="statement not covered" >      reject(new Error('The `triplesec.decrypt` function must be provided'));</span>
    }
    triplesecDecrypt(
      {
...
export async function decryptMnemonic(
  ...
  try {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err instanceof PasswordError) {
