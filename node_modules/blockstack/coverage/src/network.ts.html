...
<html lang="en">
<head>
    <title>Code coverage report for src/network.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> network.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.08% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>316/385</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">75.52% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>108/143</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">82.99% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>122/147</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.94% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>313/382</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1322'></a><a href='#L1322'>1322</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { TxOutput, address as bjsAddress, networks, Transaction, payments, Network } from 'bitcoinjs-lib'
...
<span class="fstat-no" title="function not covered" >  broadcastTransaction(</span>transaction: string): Promise&lt;any&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error(`Not implemented, broadcastTransaction(${transaction})`))</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getBlockHeight(</span>): Promise&lt;number&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Not implemented, getBlockHeight()'))</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getTransactionInfo(</span>txid: string): Promise&lt;TransactionInfo&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error(`Not implemented, getTransactionInfo(${txid})`))</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getNetworkedUTXOs(</span>address: string): Promise&lt;UTXO[]&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error(`Not implemented, getNetworkedUTXOs(${address})`))</span>
  }
}
/**
...
&nbsp;
  ...
  coerceAddress(address: string) {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (pubKeyHashes.indexOf(version) &gt;= 0) {
      coercedVersion = this.layer1.pubKeyHash
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error(`Unrecognized address version number ${version} in ${address}`)</span>
    }
...
&nbsp;
  ...
  getNamePriceV1(fullyQualifiedName: string): Promise&lt;PriceInfo&gt; {
    ...
    return fetchPrivate(`${this.blockstackAPIUrl}/v1/prices/names/${fullyQualifiedName}`)
      .then((resp) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!resp.ok) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Failed to query name price for ${fullyQualifiedName}`)</span>
        }
        return resp
      })
      .then(resp =&gt; resp.json())
      ...
      .then((namePrice) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!namePrice || !namePrice.satoshis) {
<span class="cstat-no" title="statement not covered" >          throw new Error(</span>
            `Failed to get price for ${fullyQualifiedName}. Does the namespace exist?`
          )
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (namePrice.satoshis &lt; this.DUST_MINIMUM) {
...
&nbsp;
  ...
  getNamespacePriceV1(namespaceID: string): Promise&lt;PriceInfo&gt; {
    ...
    return fetchPrivate(`${this.blockstackAPIUrl}/v1/prices/namespaces/${namespaceID}`)
      .then((resp) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!resp.ok) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Failed to query name price for ${namespaceID}`)</span>
        }
        return resp
      })
      .then(resp =&gt; resp.json())
      .then((namespacePrice) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!namespacePrice || !namespacePrice.satoshis) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Failed to get price for ${namespaceID}`)</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (namespacePrice.satoshis &lt; this.DUST_MINIMUM) {
<span class="cstat-no" title="statement not covered" >          namespacePrice.satoshis = this.DUST_MINIMUM</span>
        }
        const result = {
          units: 'BTC',
  ...
  getNamePriceV2(fullyQualifiedName: string): Promise&lt;PriceInfo&gt; {
    return fetchPrivate(`${this.blockstackAPIUrl}/v2/prices/names/${fullyQualifiedName}`)
      ...
      .then(resp =&gt; resp.name_price)
      .then((namePrice) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!namePrice) {
<span class="cstat-no" title="statement not covered" >          throw new Error(</span>
            `Failed to get price for ${fullyQualifiedName}. Does the namespace exist?`
          )
        }
...
&nbsp;
  ...
  getNamespacePriceV2(namespaceID: string): Promise&lt;PriceInfo&gt; {
    return fetchPrivate(`${this.blockstackAPIUrl}/v2/prices/namespaces/${namespaceID}`)
      ...
      .then(resp =&gt; resp.json())
      .then((namespacePrice) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!namespacePrice) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Failed to get price for ${namespaceID}`)</span>
        }
        const result = {
        ...
        if (namespacePrice.units === 'BTC') {
          // must be at least dust-minimum
          const dustMin = new BN(String(this.DUST_MINIMUM))
          <span class="missing-if-branch" title="if path not taken" >I</span>if (result.amount.ucmp(dustMin) &lt; 0) {
<span class="cstat-no" title="statement not covered" >            result.amount = dustMin</span>
          }
        }
        return result
      })
  ...
  getNamespaceBurnAddress(namespace: string): Promise&lt;string&gt; {
    return Promise.all([
      ...
      .then(([resp, blockHeight]) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (resp.status === 404) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`No such namespace '${namespace}'`)</span>
        } else {
  ...
  getNameInfo(fullyQualifiedName: string) {
    ...
    return fetchPrivate(nameLookupURL)
      .then((resp) =&gt; {
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (resp.status !== 200) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Bad response status: ${resp.status}`)</span>
        } else {
          return resp.json()
        }
      })
  ...
  getNamespaceInfo(namespaceID: string) {
    return fetchPrivate(`${this.blockstackAPIUrl}/v1/namespaces/${namespaceID}`)
      ...
      .then((namespaceInfo) =&gt; {
        ...
        //  blockstackd gets into trouble because it tries to coerce back to mainnet
        //  and the regtest transaction generation libraries want to use testnet addresses
        <span class="missing-if-branch" title="if path not taken" >I</span>if (namespaceInfo.address &amp;&amp; namespaceInfo.recipient_address) {
<span class="cstat-no" title="statement not covered" >          return Object.assign({}, namespaceInfo, {</span>
...
&nbsp;
  ...
  getZonefile(zonefileHash: string): Promise&lt;string&gt; {
    return fetchPrivate(`${this.blockstackAPIUrl}/v1/zonefiles/${zonefileHash}`)
      .then((resp) =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (resp.status === 200) {
          return resp.text()
            .then(async (body) =&gt; {
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Bad response status: ${resp.status}`)</span>
      ...
      .then((historyList) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (historyList.error) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to get account history page: ${historyList.error}`)</span>
        }
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Bad response status: ${resp.status}`)</span>
      ...
      .then((historyList) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (historyList.error) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to get historic account state: ${historyList.error}`)</span>
        }
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Bad response status: ${resp.status}`)</span>
      ...
      .then((tokenList) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (tokenList.error) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to get token list: ${tokenList.error}`)</span>
        }
        return tokenList
      })
  }
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Bad response status: ${resp.status}`)</span>
      ...
      .then((tokenBalance) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (tokenBalance.error) {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Unable to get account balance: ${tokenBalance.error}`)</span>
        }
        let balance = '0'
...
&nbsp;
  ...
  broadcastTransaction(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!transaction) {
      const error = <span class="cstat-no" title="statement not covered" >new MissingParameterError('transaction')</span>
<span class="cstat-no" title="statement not covered" >      return Promise.reject(error)</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!confirmations &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >confirmations !== 0)</span> {
      const error = <span class="cstat-no" title="statement not covered" >new MissingParameterError('confirmations')</span>
<span class="cstat-no" title="statement not covered" >      return Promise.reject(error)</span>
    }
&nbsp;
...
&nbsp;
   ...
   * @ignore
   */
<span class="fstat-no" title="function not covered" >  countDustOutputs(</span>) {
...
&nbsp;
      let includeSet: UTXO[] = []
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.includeUtxoMap.hasOwnProperty(address)) {
<span class="cstat-no" title="statement not covered" >        includeSet = includeSet.concat(this.includeUtxoMap[address])</span>
      }
&nbsp;
      includeSet.push({
        tx_hash: txHash,
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getTransactionInfo(</span>txHash: string): Promise&lt;TransactionInfo&gt; {
<span class="cstat-no" title="statement not covered" >    return this.btc.getTransactionInfo(txHash)</span>
  }
&nbsp;
  /**
   * @ignore
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getFeeRate(</span>): Promise&lt;number&gt; {
<span class="cstat-no" title="statement not covered" >    return Promise.resolve(Math.floor(0.00001000 * SATOSHIS_PER_BTC))</span>
  }
}
&nbsp;
/**
...
&nbsp;
<span class="fstat-no" title="function not covered" >  broadcastTransaction(</span>transaction: string) {
    const jsonRPC = <span class="cstat-no" title="statement not covered" >{</span>
      jsonrpc: '1.0',
      method: 'sendrawtransaction',
      params: [transaction]
    }
    const authString =      <span class="cstat-no" title="statement not covered" >Buffer.from(`${this.bitcoindCredentials.username}:${this.bitcoindCredentials.password}`)</span>
      .toString('base64')
    const headers = <span class="cstat-no" title="statement not covered" >{ Authorization: `Basic ${authString}` }</span>
<span class="cstat-no" title="statement not covered" >    return fetchPrivate(this.bitcoindUrl, {</span>
      method: 'POST',
      body: JSON.stringify(jsonRPC),
      headers
    })
      .then(<span class="fstat-no" title="function not covered" >resp </span>=&gt; <span class="cstat-no" title="statement not covered" >resp.json())</span>
      .then(<span class="fstat-no" title="function not covered" >respObj </span>=&gt; <span class="cstat-no" title="statement not covered" >respObj.result)</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getBlockHeight(</span>) {
    const jsonRPC = <span class="cstat-no" title="statement not covered" >{</span>
      jsonrpc: '1.0',
...
<span class="cstat-no" title="statement not covered" >    return fetchPrivate(this.bitcoindUrl, {</span>
      ...
      .then(<span class="fstat-no" title="function not covered" >resp </span>=&gt; <span class="cstat-no" title="statement not covered" >resp.json())</span>
      .then(<span class="fstat-no" title="function not covered" >respObj </span>=&gt; <span class="cstat-no" title="statement not covered" >respObj.result)</span>
      .then(<span class="fstat-no" title="function not covered" >txInfo </span>=&gt; <span class="cstat-no" title="statement not covered" >txInfo.blockhash)</span>
      .then(<span class="fstat-no" title="function not covered" >(b</span>lockhash) =&gt; {
        const jsonRPCBlock = <span class="cstat-no" title="statement not covered" >{</span>
          jsonrpc: '1.0',
          method: 'getblockheader',
          params: [blockhash]
        }
<span class="cstat-no" title="statement not covered" >        headers.Authorization = `Basic ${authString}`</span>
<span class="cstat-no" title="statement not covered" >        return fetchPrivate(this.bitcoindUrl, {</span>
          method: 'POST',
      ...
      .then(<span class="fstat-no" title="function not covered" >resp </span>=&gt; <span class="cstat-no" title="statement not covered" >resp.json())</span>
      .then(<span class="fstat-no" title="function not covered" >(r</span>espObj) =&gt; {
<span class="cstat-no" title="statement not covered" >        if (!respObj || !respObj.result) {</span>
          // unconfirmed 
<span class="cstat-no" title="statement not covered" >          throw new Error('Unconfirmed transaction')</span>
        } else {
<span class="cstat-no" title="statement not covered" >          return { block_height: respObj.result.height }</span>
        }
      })
  }
&nbsp;
...
<span class="fstat-no" title="function not covered" >        (x</span>: any) =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
...
export class InsightClient extends BitcoinNetwork {
  apiUrl: string
&nbsp;
  constructor(insightUrl: string = <span class="branch-0 cbranch-no" title="branch not covered" >'https://utxo.technofractal.com/')</span> {
    super()
...
&nbsp;
  getNetworkedUTXOs(address: string): Promise&lt;UTXO[]&gt; {
    return fetchPrivate(`${this.utxoProviderUrl}/unspent?format=json&amp;active=${address}&amp;cors=true`)
      .then((resp) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (resp.status === 500) {
<span class="cstat-no" title="statement not covered" >          Logger.debug('UTXO provider 500 usually means no UTXOs: returning []')</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getTransactionInfo(</span>txHash: string): Promise&lt;TransactionInfo&gt; {
<span class="cstat-no" title="statement not covered" >    return fetchPrivate(`${this.utxoProviderUrl}/rawtx/${txHash}?cors=true`)</span>
      .then(<span class="fstat-no" title="function not covered" >(r</span>esp) =&gt; {
<span class="cstat-no" title="statement not covered" >        if (resp.status === 200) {</span>
<span class="cstat-no" title="statement not covered" >          return resp.json()</span>
        } else {
<span class="cstat-no" title="statement not covered" >          throw new Error(`Could not lookup transaction info for '${txHash}'. Server error.`)</span>
        }
      })
      .then(<span class="fstat-no" title="function not covered" >respObj </span>=&gt; (<span class="cstat-no" title="statement not covered" >{ block_height: respObj.block_height })</span>)
  }
&nbsp;
  broadcastTransaction(transaction: string) {
 ...
 * @return a promise that resolves to the WHOIS-like information 
 */
export function <span class="fstat-no" title="function not covered" >getNameInfo(</span>fullyQualifiedName: string) {
<span class="cstat-no" title="statement not covered" >  return config.network.getNameInfo(fullyQualifiedName)</span>
}
&nbsp;
/**
* @ignore
