...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/skeletons.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> skeletons.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">90.41% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>245/271</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">68.42% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>65/95</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">90.3% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>242/268</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L767'></a><a href='#L767'>767</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  constructor(namespaceID: string) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (namespaceID.length &gt; 19) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Namespace ID too long (19 chars max)')</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!namespaceID.match('[0123456789abcdefghijklmnopqrstuvwxyz_-]+')) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Namespace ID can only use characters 0123456789abcdefghijklmnopqrstuvwxyz-_')</span>
    }
&nbsp;
...
&nbsp;
  setVersion(version: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (version &lt; 0 || version &gt; 2 ** 16 - 1) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid version: must be a 16-bit number')</span>
    }
    this.version = version
  }
&nbsp;
  setLifetime(lifetime: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (lifetime &lt; 0 || lifetime &gt; 2 ** 32 - 1) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid lifetime: must be a 32-bit number')</span>
    }
    this.lifetime = lifetime
  }
&nbsp;
  setCoeff(coeff: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (coeff &lt; 0 || coeff &gt; 255) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid coeff: must be an 8-bit number')</span>
    }
    this.coeff = coeff
  }
&nbsp;
  setBase(base: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (base &lt; 0 || base &gt; 255) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid base: must be an 8-bit number')</span>
    }
    this.base = base
  }
&nbsp;
  setBuckets(buckets: Array&lt;number&gt;) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (buckets.length !== 16) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid buckets: must have 16 entries')</span>
    }
&nbsp;
    for (let i = 0; i &lt; buckets.length; i++) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (buckets[i] &lt; 0 || buckets[i] &gt; 15) {
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid buckets: must be 4-bit numbers')</span>
      }
    }
&nbsp;
...
&nbsp;
  setNonalphaDiscount(nonalphaDiscount: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (nonalphaDiscount &lt;= 0 || nonalphaDiscount &gt; 15) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid nonalphaDiscount: must be a positive 4-bit number')</span>
    }
    this.nonalphaDiscount = nonalphaDiscount
  }
&nbsp;
  setNoVowelDiscount(noVowelDiscount: number) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (noVowelDiscount &lt;= 0 || noVowelDiscount &gt; 15) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid noVowelDiscount: must be a positive 4-bit number')</span>
    }
...
function asAmountV2(amount: AmountType): AmountTypeV2 {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof amount === 'number') {
<span class="cstat-no" title="statement not covered" >    return { units: 'BTC', amount: new BN(String(amount)) }</span>
  } else {
...
function opEncode(opcode: string): string {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (res.length !== 3) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Runtime error: invalid MAGIC_BYTES')</span>
  }
  return res
}
&nbsp;
...
export function makePreorderSkeleton(
  ...
  registerAddress: string = <span class="branch-0 cbranch-no" title="branch not covered" >null</span>
): Transaction {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!!registerAddress) {
...
&nbsp;
  if (burnAmount.units !== 'BTC') {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (burnHex.length &gt; 16) {
      // exceeds 2**64; can't fit
<span class="cstat-no" title="statement not covered" >      throw new Error(`Cannot preorder '${fullyQualifiedName}': cannot fit price into 8 bytes`)</span>
    }
...
export function makeRegisterSkeleton(
  ...
  valueHash: string = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> burnTokenAmountHex: string = null
) {
...
&nbsp;
  let payload
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!!burnTokenAmountHex &amp;&amp; !valueHash) {
    // empty value hash
<span class="cstat-no" title="statement not covered" >    valueHash = '0000000000000000000000000000000000000000'</span>
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!!valueHash) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (valueHash.length !== 40) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Value hash length incorrect. Expecting 20-bytes, hex-encoded')</span>
    }
    if (!!burnTokenAmountHex) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (burnTokenAmountHex.length !== 16) {
<span class="cstat-no" title="statement not covered" >        throw new Error('Burn field length incorrect.  Expecting 8-bytes, hex-encoded')</span>
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    payload = Buffer.from(fullyQualifiedName, 'ascii')</span>
  }
&nbsp;
...
export function makeRenewalSkeleton(
  ...
  burnAddress: string, burn: AmountType, valueHash: string = <span class="branch-0 cbranch-no" title="branch not covered" >null</span>
) {
  /*
    Formats
&nbsp;
...
&nbsp;
  ...
  */
  ...
  if (!!burnTokenAmount) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (burnHex.length &gt; 16) {
      // exceeds 2**64; can't fit 
<span class="cstat-no" title="statement not covered" >      throw new Error(`Cannot renew '${fullyQualifiedName}': cannot fit price into 8 bytes`)</span>
    }
...
&nbsp;
  ...
  */
  ...
  let keepChar = '~'
  <span class="missing-if-branch" title="if path not taken" >I</span>if (keepZonefile) {
<span class="cstat-no" title="statement not covered" >    keepChar = '&gt;'</span>
  }
&nbsp;
...
&nbsp;
  const burnAmount = asAmountV2(burn)
  <span class="missing-if-branch" title="if path not taken" >I</span>if (burnAmount.units !== 'BTC' &amp;&amp; burnAmount.units !== 'STACKS') {
<span class="cstat-no" title="statement not covered" >    throw new Error(`Invalid burnUnits ${burnAmount.units}`)</span>
  }
&nbsp;
  const network = config.network
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (burnAmount.units === 'STACKS') {
    opReturnBufferLen = 47
  } else {
<span class="cstat-no" title="statement not covered" >    btcBurnAmount = burnAmount.amount.toNumber()</span>
  }
&nbsp;
  const opReturnBuffer = Buffer.alloc(opReturnBufferLen)
  opReturnBuffer.write(opEncode('*'), 0, 3, 'ascii')
 ...
 */
  <span class="missing-if-branch" title="if path not taken" >I</span>if (zonefileHash.length !== 40) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid zonefile hash: must be 20 bytes hex-encoded')</span>
  }
&nbsp;
  const network = config.network
...
&nbsp;
    output 0: the OP_RETURN
  */
  <span class="missing-if-branch" title="if path not taken" >I</span>if (messageHash.length !== 40) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid message hash: must be 20 bytes hex-encoded')</span>
  }
&nbsp;
...
&nbsp;
  ...
  */
  <span class="missing-if-branch" title="if path not taken" >I</span>if (scratchArea.length &gt; 34) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid scratch area: must be no more than 34 bytes')</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (tokenValueHex.length &gt; 16) {
    // exceeds 2**64; can't fit
<span class="cstat-no" title="statement not covered" >    throw new Error(`Cannot send tokens: cannot fit ${tokenAmount.toString()} into 8 bytes`)</span>
  }
&nbsp;
