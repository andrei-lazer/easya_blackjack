...
<html lang="en">
<head>
    <title>Code coverage report for src/operations/txbuild.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/operations</a> txbuild.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.42% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>296/307</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">96.41% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>295/306</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1218'></a><a href='#L1218'>1218</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
function addOwnerInput(utxos: UTXO[],
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (utxos.length &lt;= 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Owner has no UTXOs for UPDATE.')</span>
  }
&nbsp;
...
function returnTransactionHex(txB: TransactionBuilder,
                              buildIncomplete: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >false</span>
) {
  if (buildIncomplete) {
...
function estimateRegister(fullyQualifiedName: string,
                          ...
                          paymentAddress: string,
                          includingZonefile: boolean = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span>
                          paymentUtxos: number = <span class="branch-0 cbranch-no" title="branch not covered" >1</span>
): Promise&lt;number&gt; {
  const network = config.network
&nbsp;
  let valueHash
  <span class="missing-if-branch" title="else path not taken" >E</span>if (includingZonefile) {
...
function estimateTokenTransfer(recipientAddress: string,
                               ...
                               tokenAmount: BN,
                               scratchArea: string,
                               senderUtxos: number = <span class="branch-0 cbranch-no" title="branch not covered" >1,</span>
...
async function makeUpdate(fullyQualifiedName: string,
  ...
  const network = config.network
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!valueHash &amp;&amp; !zonefile) {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(</span>
      new Error('Need zonefile or valueHash arguments')
    )
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (valueHash.length === 0) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!zonefile) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(</span>
        new Error('Need zonefile or valueHash arguments')
      )
    }
    valueHash = hash160(Buffer.from(zonefile)).toString('hex')
  } else <span class="cstat-no" title="statement not covered" >if (valueHash.length !== 40) {</span>
<span class="cstat-no" title="statement not covered" >    return Promise.reject(</span>
...
async function makeRegister(fullyQualifiedName: string,
                            registerAddress: string,
                            paymentKeyIn: string | TransactionSigner,
                            zonefile: string = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span>
                            valueHash: string = null,
                            buildIncomplete: boolean = false
): Promise&lt;string&gt; {
  const network = config.network
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!valueHash &amp;&amp; !!zonefile) {
    valueHash = hash160(Buffer.from(zonefile)).toString('hex')
  } else <span class="cstat-no" title="statement not covered" >if (!!valueHash &amp;&amp; valueHash.length !== 40) {</span>
<span class="cstat-no" title="statement not covered" >    return Promise.reject(</span>
...
&nbsp;
      return Promise.all([txPromise, network.getUTXOs(paymentAddress),
        ...
        .then(([txB, payerUtxos, ownerUtxos, feeRate]) =&gt; {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (ownerOutputAddr !== ownerAddress) {
<span class="cstat-no" title="statement not covered" >            return Promise.reject(</span>
...
async function makeNamespaceReveal(namespace: BlockstackNamespace,
  ...
  const network = config.network
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!namespace.check()) {
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new Error('Invalid namespace'))</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return Promise.reject(new InvalidParameterError('amount', 'amount must be greater than zero'))</span>
  }
&nbsp;
  const network = config.network
&nbsp;
...
&nbsp;
      ...
      try {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (err.name === 'NotEnoughFundsError') {
