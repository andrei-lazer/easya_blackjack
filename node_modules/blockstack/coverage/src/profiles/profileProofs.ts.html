...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/profileProofs.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/profiles</a> profileProofs.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { profileServices } from './services'
...
export function validateProofs(profile: any,
                               ...
                               name: string = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span>: Promise&lt;AccountProofInfo[]&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!profile) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Profile must not be null')</span>
  }
&nbsp;
  let accounts: any[] = []
  const proofsToValidate: Promise&lt;AccountProofInfo&gt;[] = []
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (profile.hasOwnProperty('account')) {
