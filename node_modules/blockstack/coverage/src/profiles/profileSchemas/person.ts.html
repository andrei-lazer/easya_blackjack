...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/profileSchemas/person.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/profiles/profileSchemas</a> person.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  static validateSchema(profile: any, strict = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
    schemaDefinition.strict = strict
    return inspector.validate(schemaDefinition, profile)
  }
&nbsp;
  static fromToken(token: string, publicKeyOrAddress: string | null = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span>: Person {
