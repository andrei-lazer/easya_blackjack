...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/services/instagram.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/profiles/services</a> instagram.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    for (let i = 0; i &lt; baseUrls.length; i++) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (normalizedProofUrl.startsWith(`${baseUrls[i]}`)) {
...
&nbsp;
  getProofIdentity(searchText: string, cheerio: CheerioModuleType) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (username !== undefined &amp;&amp; username.split(':').length &gt; 1) {
...
&nbsp;
  getProofStatement(searchText: string, cheerio: CheerioModuleType) {
    ...
    const statement = $('meta[property="og:description"]')
      .attr('content')
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (statement !== undefined &amp;&amp; statement.split(':').length &gt; 1) {
