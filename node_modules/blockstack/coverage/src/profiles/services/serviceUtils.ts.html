...
<html lang="en">
<head>
    <title>Code coverage report for src/profiles/services/serviceUtils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/profiles/services</a> serviceUtils.ts
    </h1>
    <div class='clearfix'>
 ...
 * @ignore
 */
export function containsValidProofStatement(searchText: string, name: string | null = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span> {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (username != null
      &amp;&amp; searchText.includes('verifymyonename')
      &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >searchText.includes(`+${username}`))</span> {
