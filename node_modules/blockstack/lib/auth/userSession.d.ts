...
export declare class UserSession {
     ...
     */
    encryptContent(content: string | Buffer, options?: import('../storage').EncryptContentOptions): Promise<string>;
    /**
     ...
     * if it failed
     */
    putFile(path: string, content: string | Buffer | ArrayBufferView | Blob, options?: import('../storage').PutFileOptions): Promise<string>;
    /**
