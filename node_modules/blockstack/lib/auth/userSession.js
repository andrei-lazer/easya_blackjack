...
class UserSession {
    ...
    redirectToSignIn(redirectURI, manifestURI, scopes) {
        ...
        return authApp_1.redirectToSignInWithAuthRequest(authRequest, authenticatorURL);
    }
    /**
    ...
    getAuthResponseToken() {
        return authApp_1.getAuthResponseToken();
    }
    /**
     ...
     */
    isSignInPending() {
        return authApp_1.isSignInPending();
    }
    /**
    ...
    handlePendingSignIn(authResponseToken = this.getAuthResponseToken()) {
        ...
        return authApp_1.handlePendingSignIn(undefined, authResponseToken, transitKey, this);
    }
    /**
    ...
    signUserOut(redirectURL) {
        authApp_1.signUserOut(redirectURL, this);
    }
    /**
